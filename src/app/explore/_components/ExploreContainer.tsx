  ...
  return (
    <div className="w-[80%]">
      ...
      <div className="pb-[24px] relative">
        <Input onChange={onChangeHandler} className="w-[244px] h-[36px] pl-[35px]" placeholder="Search name" />
        <Search className="absolute size-[16px] top-[10px] left-[12px] opacity-50"/>
      </div>
      {ExploreData.length > 0 ? ExploreData.map((item:any)=>(
