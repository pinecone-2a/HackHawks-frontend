export default function SuccessPage() {
    return <div className="w-[650px] min-h-[250px] text-black gap-1 p-[24px] flex flex-col rounded-[9px] border-[#E4E4E7] border-[1px] ">
        ...
        <textarea className="rounded-[6px] border-[#E4E4E7] border-[1px] min-h-[100px]" placeholder="Thank you for supporting me! It means lot to have your support. it's a step toward creating a more inclusive and accepting community of artists." />
