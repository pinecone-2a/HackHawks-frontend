  ...
  return (
    <div className="w-[650px] min-h-[570px] text-black gap-3 p-6 flex flex-col rounded-lg border border-gray-300">
      ...
      <div className="w-[160px] h-[160px] rounded-full bg-gray-700 relative mb-5">
        ...
        {selectedImage ? <img src={selectedImage} alt="Profile" className="w-full h-full rounded-full object-cover" /> : <div className="w-full h-full rounded-full flex items-center justify-center text-white">No Image</div>}
      </div>

      <h2 className="text-sm font-semibold">Name</h2>
      <input type="text" name="name" value={profileData.name} onChange={handleChange} className="rounded-md border border-gray-300 p-2" placeholder="Enter your name" />

      <h2 className="text-sm font-semibold">About</h2>
      <textarea name="about" value={profileData.about} onChange={handleChange} className="rounded-md border border-gray-300 p-2 min-h-[100px]" placeholder="Tell something about yourself..." />

      <h2 className="text-sm font-semibold">Social Media URL</h2>
      <input type="text" name="socialUrl" value={profileData.socialUrl} onChange={handleChange} className="rounded-md border border-gray-300 p-2" placeholder="https://your-social-link.com" />
