  ...
  return (
    <div className="max-w-lg bg-white border border-gray-300 rounded-lg p-6 z-3">
      ...
      <div className="mb-4">
        ...
        <input type="text" placeholder="buymeacoffee.com/" className="w-full mt-1 p-2 border rounded-lg focus:ring focus:ring-gray-200 outline-none" />
      </div>

      <div className="mb-4">
        <label className="text-sm font-medium">Special message:</label>
        {/* onChange={} */}
        <textarea placeholder="Please write your message here" className="w-full mt-1 p-2 border rounded-lg focus:ring focus:ring-gray-200 outline-none" rows={3} />
      </div>
